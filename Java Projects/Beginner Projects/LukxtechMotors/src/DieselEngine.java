public class DieselEngine extends Engines
{
    ...
    public DieselEngine(String[]modelNumber, int[]pistonDisplacement, int[]maxPower, int[]maxRPM, int[]maxTorque, int[]weightOfEngine, int[]cylinders, String[]compressionRatio)
    {
