public class CNGEngine extends Engines
{
    ...
    public CNGEngine(String[]modelNumber, int[]pistonDisplacement, int[]maxPower, int[]maxRPM, int[]maxTorque, int[]weightOfEngine, int[]cylinders, String[]compressionRatio)
    {
